...
class ExampleGlassRefraction : public ExampleBase
{
public:
    ExampleGlassRefraction(int width, int height) : ExampleBase(width, height) {}
...
int main()
{
    ...
    ExampleGlassRefraction example(imageWidth, imageHeight);
